# -*- coding: utf-8 -*-
"""MSDSNetworkAnalysis_HW1_TwitterData.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1eOqTh8To6eEE9lMe6pgdeLbfDMHFqgG_
...
def match_tweet(tweet, country_codes=None, start_date=None, end_date=None):
    ...
    if not country_codes==None:
      for i in range(len(country_codes)):
        country_codes[i]=country_codes[i].upper()
    #print(country_codes)
    cd=datetime.strptime(tweet['created_at'], "%a %b %d %H:%M:%S %z %Y").date()
    code=None
    #print(type(tweet))
    if 'place' in tweet and not tweet['place'] == None:
      ...
      if 'country_code' in tweet['place']:
        #print('OK')
        code=tweet['place']['country_code'].upper()

    if (not country_codes==None and not country_codes==[] and not code in country_codes):
      return False
    if not start_date==None:
      if not start_date<=cd:
        return False
...
start = date.fromisoformat("2021-11-01")
end = date.fromisoformat("2021-11-30")
