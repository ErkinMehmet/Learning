# -*- coding: utf-8 -*-
"""MSDSTopicModel_HW2_BuildATopicModel.V2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1XEZxMFRZz6q5aeI7rXlIFrKz8MkmK7qc
...
def build_corpus(texts, lang="en"):
    ...
    to_lowercase(corpus)
    print(type(corpus))
    #remove_chars(corpus,remove_digits=True,remove_punct=True)
    filter_clean_tokens(corpus,remove_shorter_than=2, remove_punct=True,remove_numbers=True)
